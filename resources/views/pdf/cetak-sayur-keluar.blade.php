...
<body>
  <div class="container">
    <h3 style=" font-family: 'Plus Jakarta Sans', sans-serif; text-align: center;">Laporan Sayur Keluar</h3>
    ...
    <div class="table-responsive">
      <table style="border-collapse: collapse; width: 100%;">
        <tr>
            ...
            <th style="border: 1px solid #000; padding: 8px; text-align: left">Jumlah sayur Keluar</th>
            <th style="border: 1px solid #000; padding: 8px; text-align: left">Tanggal Keluar</th>
        </tr>
        ...
        <tr>
            ...
            <td style="border: 1px solid #000; padding: 8px; text-align: left">{{ $item->tanggal_keluar->setTimezone('Asia/Jakarta')->format('d/m/Y') }}</td>
        </tr>
        @endforeach
      </table>
    </div>
